        ...
        <div class="relative bg-white rounded-xl shadow-xl dark:bg-gray-800">
            ...
            <form action="{{ route('employees.update', $employee->id) }}" method="POST" class="p-6 md:p-8">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="date" name="tanggal_lahir" id="tanggal_lahir_{{ $employee->id }}" required 
                                   ...
                                   class="block w-full rounded-lg border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-amber-600 sm:text-sm sm:leading-6 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-amber-500 dark:scheme:dark">
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-end gap-x-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-600">
                    <button type="submit" class="rounded-lg bg-amber-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-amber-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-amber-600 transition">
                        Simpan Perubahan
                    </button>
                </div>
